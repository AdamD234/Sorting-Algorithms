...
const Tone = {
  ...
  /**
   * This functions corresponds a flat tone notation, to a sharp musical accident
...
const VOLUME_CURVE = [0.1,0.1];
// [1.0, 0.61, 0.37, 0.22, 0.14, 0.08, 0.05, 0.0];
...
// Plays single tones. Helper function for playChord and playTone, but can also be used by itself.
